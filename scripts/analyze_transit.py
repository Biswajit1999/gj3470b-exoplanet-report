"""Transit-window analysis of a real TESS SPOC light curve for GJ 3470 b.
...
DATA_FILE = DATA_DIR / "tess2021284114741-s0044-0000000019028197-0215-s_lc.fits"
PLANET = "GJ 3470 b"
PERIOD_DAYS = 3.3366496
EPOCH_BJD = 2455983.70421
DURATION_HOURS = 1.8984
SECTOR = 44
FIGURE_FILE = FIG_DIR / "gj3470b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#087f5b", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#087f5b", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#087f5b", alpha=0.08)
